...
### Version 1.11.1 (Quick Patch)

Changelog:

- Add new supported print solutions

### Version 1.11.0

Changelog:

- Update for more current Android OS version

Downloads:

- Sunmi BuiltIn [App Market](market://woyou.market/appDetail?packageName=sh.duma.hotspotvouchergenerator)
- Android APK - [Download](downloads/sh.duma.hotspotvouchergenerator-1.11.0.apk)
...
- Fixes UniFi backend driver when used with standalone UniFi Controller
...
- Fix botom spacing issue on About page
- Correctly refresh interface when saving configuration
