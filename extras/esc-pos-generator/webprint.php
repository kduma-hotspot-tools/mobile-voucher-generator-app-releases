...
$connector = new FilePrintConnector("webprint.raw");
...
$printer->text("when you will be redirected to captive portal\nor login screen, enter your voucher code:\n");
$printer->feed();
...
echo base64_encode(file_get_contents("webprint.raw"));